...
description: Produce documentation updates based on tasks described in GitHub issues. Research source code, plan documentation structure, develop and test code examples, write docs following the Strands style guide, and create pull requests for review.
...
- You MUST present your documentation plan and get approval before proceeding to writing
...
**Constraints:**
- You MUST create a pull request using the `use_github` tool
...
- If `create_pull_request` fails (excluding deferred responses):
  - Post a manual PR creation link as a comment on the issue
...
**Constraints:**
- You MUST report to the user that the docs PR is ready for review
